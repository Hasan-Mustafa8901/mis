...
def seed_masters():
    with Session(engine) as session:
        ...
        components = [
            ...
            ("Micro Segment (Solar Roof Top)", "discount", "discount_allowed", 4),
            ("SBI Yono", "discount", "discount_allowed", 5),
            ("Power Of  12", "discount", "discount_allowed", 6),
            ("Shop Share Smile (SSS)", "discount", "discount_allowed", 7),
            ("Alliance Offer", "discount", "discount_allowed", 8),
            ("Green Bonus", "discount", "discount_allowed", 9),
            ("Additional for Exchange Customers", "discount", "discount_allowed", 10),
            ("Additional for Scrappage Customers", "discount", "discount_allowed", 11),
            (
